...
BOT_USERNAME = environ.get("BOT_USERNAME", "Annamoviesbot")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002387771498 -1002486699450') #Channel / Group Id for force sub ( make sure bot is admin )
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ: ANNA')
